...
const JobImportModal: React.FC<JobImportModalProps> = ({ isOpen, onClose, onComplete }) => {
        ...
        const batchPromise = (async () => {
          ...
          for (const row of batchRows) {
            try {
              ...
              // Add job to batch
              batch.set(doc(db, 'jobs', jobId), job, { merge: true });
              ...
              if (customerSnap.exists()) {
                ...
                if (locIdx !== -1) {
                  ...
                  if (!loc.jobs.includes(jobId)) loc.jobs.push(jobId);
